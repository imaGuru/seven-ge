...
public class ShaderProgramTest extends BaseOpenGLES20UnitTest {
	...
	public void testColorProgramLoading() throws Throwable {
		runOnGLThread(new TestWrapper() {
			...
			public void executeTest() throws Throwable {
				int v = ShaderUtils.compileShader(IO.readToString(IO
						.openAsset("Shaders/simple_vertex_shader.glsl")),
						GLES20.GL_VERTEX_SHADER);
				int f = ShaderUtils.compileShader(IO.readToString(IO
						.openAsset("Shaders/simple_fragment_shader.glsl")),
	...
	public void testTextureProgramLoading() throws Throwable {
		runOnGLThread(new TestWrapper() {
			...
			public void executeTest() throws Throwable {
				int v = ShaderUtils.compileShader(IO.readToString(IO
						.openAsset("Shaders/texture_vertex_shader.glsl")),
						GLES20.GL_VERTEX_SHADER);
				int f = ShaderUtils.compileShader(IO.readToString(IO
						.openAsset("Shaders/texture_fragment_shader.glsl")),
						GLES20.GL_FRAGMENT_SHADER);
