...
public class World {
	...
	private float reportRayFixture(long addr, float pX, float pY, float nX,
		...
		if (rayCastCallback != null)
			return rayCastCallback.reportRayFixture(fixtures.get(addr),
					rayPoint.set(pX, pY), rayNormal.set(nX, nY), fraction);
		else
			return 0.0f;
	}
	...
	public Body createBody(BodyDef def) {
		Body body = new Body(this, jniCreateBody(addr, def.type.getValue(),
	 ...
	 * need to call this function. See {@link #setAutoClearForces(boolean)}
	 */
