...
/**
 * A line joint. This joint provides two degrees of freedom: translation along
 * an axis fixed in body1 and rotation in the plane. You can use a joint limit
 * to restrict the range of motion and a joint motor to drive the motion or to
...
public class LineJoint extends Joint {
	...
	/**
	 * Set/Get the maximum motor force, usually in N. FIXME returns 0 at the
	 * moment due to a linking problem.
	 */
