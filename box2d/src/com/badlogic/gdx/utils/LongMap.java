...
public class LongMap<V> {
	...
	public LongMap(int initialCapacity, float loadFactor) {
		...
		pushIterations = Math.max(Math.min(capacity, 32),
				(int) Math.sqrt(capacity) / 4);
	...
	private void push(long insertKey, V insertValue, int index1, long key1,
			int index2, long key2, int index3, long key3) {
