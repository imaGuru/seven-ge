...
public class GameStateManager {
	 ...
	 * 
	 * @param currentState
	 *            the GameState instance which will be set
	 */
	public void setCurrentState(GameState currentState) {
		...
		/*
		 * ensures that onSurfaceChange will be called at the beginning of new
		 * state and not before width and height are set at least once
		 */
