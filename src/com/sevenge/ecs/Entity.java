...
/** Class representing an entity. An entity is composed of components holding properties of the given entity. The type of
 * components held by this entity can be devised by looking at its component mask. */
public class Entity {
	public int mId;
	public int mMask;
