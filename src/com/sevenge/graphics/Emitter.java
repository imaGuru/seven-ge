...
public class Emitter {
	 ...
	 *            to be used by the emitter
	 * @param color
	 *            of the emitted particles
	 * @param angleVarianceInDegrees
	 *            variance in particle angle
	 * @param speedVariance
	 *            variance in particle speed
	 */
	public Emitter(ParticleSystem particleSystem, int color,
	 ...
	 */
	public void addParticles(Vector3 position, Vector3 direction,
		...
		for (int i = 0; i < count; i++) {
			...
			Matrix.multiplyMV(resultVector, 0, rotationMatrix, 0,
					directionVector, 0);

			float speedAdjustment = 1f + random.nextFloat() * speedVariance;

			Vector3 thisDirection = new Vector3(resultVector[0]
					* speedAdjustment, resultVector[1] * speedAdjustment, 0.0f);
