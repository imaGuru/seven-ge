...
public class ParticleShaderProgram {
	 ...
	 * 
	 * @param vs
	 *            vertex shader object suitable for particle rendering
	 * @param fs
	 *            fragment shader object suitable for particle rendering
	 */
	 ...
	 *            location matrix
	 * @param elapsedTime
	 *            time since the start of the particle system in seconds
	 */
