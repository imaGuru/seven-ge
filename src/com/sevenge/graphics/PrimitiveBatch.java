...
public class PrimitiveBatch implements Drawable {
	...
	public PrimitiveBatch (ColorShaderProgram colorShader, int size) {
	...
	public void add (float[] vertexData, int segments) {
		...
		// System.arraycopy(indexData, 0, mIndices, mVertexCount * 2, indexData.length);
