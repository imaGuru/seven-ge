...
public interface GestureProcessor {
	 ...
	 * 
	 * @param The
	 *            down motion event of the first tap of the double-tap.
	 * 
	 */
	 ...
	 * MotionEvent and the matching up MotionEvent. The calculated velocity is
	 * supplied along the x and y axis in pixels per second.
	 * 
	 * @param e1
	 ...
	 * 
	 * @param The
	 *            initial on down motion event that started the longpress.
	 * 
	 */
	 ...
	 * the current move MotionEvent. The distance in x and y is also supplied
	 * for convenience.
	 * 
	 * Parameters
	 * 
	 ...
	 * going up. Once a scale has ended, getFocusX() and getFocusY() will return
	 * focal point of the pointers remaining on the screen.
	 */
