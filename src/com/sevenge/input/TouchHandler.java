		...
		for (int i = 0; i < Input.NUM_TOUCHPOINTS; i++) {
			...
			synchronized (input) {
				...
				case MotionEvent.ACTION_POINTER_DOWN:
					...
					registerTouchEvent(input, TouchEvent.TOUCH_DOWN, x, y, 0, 0, pointerId, i, timeStamp);
				...
				case MotionEvent.ACTION_CANCEL:
					...
					registerTouchEvent(input, TouchEvent.TOUCH_UP, x, y, 0, 0, pointerId, i, timeStamp);
				...
				case MotionEvent.ACTION_MOVE:
					...
					registerTouchEvent(input, TouchEvent.TOUCH_MOVED, x, y, deltaX, deltaY, pointerId, i, timeStamp);
					break;
				}
