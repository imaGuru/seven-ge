  ...
  public SampleGameState(GameActivity gameActivity) {
    ...
    for (int i = 0; i < 200; i++) {
      ...
      if (rnd < 0.5f) {
        ...
        ca.frameList =
            new TextureRegion[] {(TextureRegion) SevenGE.assetManager.getAsset("enemyBlack1"),
      ...
      Matrix.translateM(cp.transform, 0, cs.textureRegion.width / 2, cs.textureRegion.height / 2,
          0f);
