	...
	public int invoke(LuaState luaState) {
		...
		while (luaState.next(-2)) {
			...
			case 1:
				...
				sc.textureRegion = (TextureRegion) SevenGE.getAssetManager()
						.getAsset(textureRegion);
			...
			case 4:
				...
				bodyDef.position.set(PhysicsSystem.WORLD_TO_BOX * x,
						PhysicsSystem.WORLD_TO_BOX * y);
