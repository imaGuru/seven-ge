...
public class FixedSizeArray<T> {
	 ...
	 *            of the container
	 * @param comparator
	 *            for finding and sorting elements
	 */
	...
	/**
	 * Removes element from collection and shifts remaining elements to fill the
	 * gap
	 * 
	 * @param object
	 *            to remove
	...
	/**
	 * Removes element with specified index from collection and shifts remaining
	 ...
	 * @param object
	 *            to find
	 * @param ignoreComparator
	 *            whether to use comparator or not
